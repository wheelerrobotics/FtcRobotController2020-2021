...
public class Heights {
    public static double highMax = 4150;
    public static double highMin = 3245;
    public static double midMax = 2769;
    public static double midMin = 2510;
    public static double lowMax = 1580;
    public static double lowMin = 1403;

    public static double flipMin = 800;

    public static double cone5 = 648; // +-
    public static double cone4 = 555;
