...
public class ControllerMapLenny implements ControllerMap {
    ...
    public void dpadLeft2() {
        ...
        bot.setSlideTarget(coneStackPresets ? Heights.cone3 : Heights.lowMax);
        TARGET_SLIDE = true;
    }

    @Override
    public void dpadRight2() {
        bot.setSlideTarget(coneStackPresets ? Heights.cone5 : Heights.midMax);
        TARGET_SLIDE = true;
    ...
    @Override
    public void dpadUp2() {
        bot.setSlideTarget(coneStackPresets ? Heights.cone4 : Heights.highMax);
        TARGET_SLIDE = true;
    }
    ...
    public void dpadDown2() {
        ...
        bot.setSlideTarget(Heights.cone);
        TARGET_SLIDE = true;
    }
    ...
    public void checkSpecialControls() {
        ...
        if (!clawMoving) {
            ...
            else bot.setArmTarget(Heights.levelArmPickup);
        }
